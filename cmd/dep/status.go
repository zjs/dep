...
// tplDetailView is the lock information provided to the template
// specified by the -f flag when the -detail flag is enabled.
type tplDetailView struct {
	Projects []tplProjectView `json:"projects,omitempty"`
	Metadata tplMetadataView  `json:"metadata,omitempty"`
}

type tplVersionView struct {
	Revision string `json:"revision,omitempty"`
	Version  string `json:"version,omitempty"`
	Branch   string `json:"branch,omitempty"`
}

type tplProjectView struct {
	Name     string         `json:"name,omitempty"`
	Packages []string       `json:"packages,omitempty"`
	Locked   tplVersionView `json:"locked,omitempty"`
	Latest   tplVersionView `json:"latest,omitempty"`
	Source   string         `json:"source,omitempty"`
}

type tplMetadataView struct {
